...
import { Plus, ListFilter, GridIcon, CalendarRange, Database } from "lucide-react";
import type { Base } from "@prisma/client";
import type { User as SessionUser } from "next-auth";

export default function DashboardLayoutClient({ user, bases, recentBases }: {
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 md:px-6 lg:px-8">
          ...
          <div className="mb-8 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 p-6 shadow-sm border border-blue-100">
            <h1 className="mb-2 text-2xl font-bold text-slate-800">欢迎回来，{user.name ?? '用户'}</h1>
